    ...
    public static void main(String[] args) {
        ...
        if (state.equals("Wisconsin")) {
            ...
            if (county.equals("Eau Clair")) {
                ...
                BigDecimal totalFormat = new BigDecimal(total);
                BigDecimal displayVal = totalFormat.setScale(2, RoundingMode.HALF_EVEN);
                System.out.print("The total is "+displayVal);
            }
            ...
            BigDecimal totalFormat = new BigDecimal(amount);
            BigDecimal displayVal = totalFormat.setScale(2, RoundingMode.HALF_EVEN);
            System.out.print("The total is "+displayVal);
        }
